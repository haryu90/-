...
# 티켓 패널 생성 함수
async def create_ticket_panel(ctx, panel_title, options: dict, category, embed_color=0xFFD1DC, author_icon="https://i.imgur.com/6rJX5KT.png"):
    ...
    embed.set_footer(text="말랑포켓 전용 티켓함")
